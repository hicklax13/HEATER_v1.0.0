...
def enriched_db(tmp_path):
    ...
    c.execute("""
        CREATE TABLE season_stats (
            ...
            ab INTEGER DEFAULT 0, h INTEGER DEFAULT 0, r INTEGER DEFAULT 0,
            avg REAL DEFAULT 0, obp REAL DEFAULT 0,
            bb INTEGER DEFAULT 0, hbp INTEGER DEFAULT 0, sf INTEGER DEFAULT 0,
            hr INTEGER DEFAULT 0, rbi INTEGER DEFAULT 0,
            sb INTEGER DEFAULT 0, ip REAL DEFAULT 0,
    ...
    c.execute(
        "INSERT INTO season_stats (player_id, season, pa, avg, hr, rbi, sb, era, whip, sv, k, games_played) VALUES (1, 2026, 80, .340, 5, 15, 3, 0, 0, 0, 0, 15)"
    )
    ...
    c.execute(
        "INSERT INTO season_stats (player_id, season, pa, avg, hr, rbi, sb, era, whip, sv, k, games_played) VALUES (2, 2026, 70, .220, 3, 10, 5, 0, 0, 0, 0, 14)"
    )
    ...
    c.execute(
        "INSERT INTO season_stats (player_id, season, pa, avg, hr, rbi, sb, era, whip, sv, k, games_played) VALUES (3, 2026, 0, 0, 0, 0, 0, 4.80, 1.35, 0, 35, 10)"
    )
    ...
    c.execute(
        "INSERT INTO season_stats (player_id, season, pa, avg, hr, rbi, sb, era, whip, sv, k, games_played) VALUES (4, 2026, 0, 0, 0, 0, 0, 3.10, 1.05, 0, 20, 8)"
    )
    ...
    c.execute(
        "INSERT INTO season_stats (player_id, season, pa, avg, hr, rbi, sb, era, whip, sv, k, games_played) VALUES (5, 2026, 60, .270, 4, 12, 2, 0, 0, 0, 0, 12)"
    )

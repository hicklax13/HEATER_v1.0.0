...
st.set_page_config(page_title="Heater | Standings", page_icon="", layout="wide")
...
st.markdown(
    '<div class="page-title-wrap"><div class="page-title"><span>PROJECTED STANDINGS</span></div></div>',
